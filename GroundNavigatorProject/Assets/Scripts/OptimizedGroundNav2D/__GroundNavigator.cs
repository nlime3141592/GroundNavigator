...
{
    [ExecuteInEditMode]
    public class __GroundNavigator : MonoBehaviour
    {
        [Range(0.01f, 3.0f)]
        ...
        public __GroundNavigatorProperty m_properties;
        ...
        private void Reset()
        {
            ...
            if(m_properties == null)
                m_properties = new __GroundNavigatorProperty();
        }
        ...
        public __GroundNavigatorProperty GetProperties()
        {
            return m_properties;
        }
