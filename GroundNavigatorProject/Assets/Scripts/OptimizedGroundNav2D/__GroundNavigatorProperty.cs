...
{
    [Serializable]
    public class __GroundNavigatorProperty
    {
        ...
        public __GroundNavigatorProperty()
        {
            m_thickness = 0.1f;
            m_count = 0;
        ...
        public void Calculate(Transform joints, float thickness)
        {
            ...
            m_positions._CheckCapacity(tCount);
            m_eulerAngles._CheckCapacity(tCount);
            m_boxSizes._CheckCapacity(tCount);
            m_overlaps._CheckCapacity(tCount);
            m_count = tCount;
            m_jointCount = jCount;
            m_plainCount = pCount;
